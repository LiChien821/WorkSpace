...
public static void sendVerificationEmail(UserAccountMt acc,HttpServletRequest request) throws UnsupportedEncodingException, MessagingException, UnknownHostException {
