...
public class ApiRestController {
	...
	public Iterable<Section> createSectionAndReturnSectionList(@PathVariable("courseID") int courseID ,@RequestBody Section inputSection) throws NoCourseException  {
...
//		service.saveCourse(asignedcourse);
	...
	@ResponseStatus(HttpStatus.CREATED)
	public CourseBasic createAbstractAndReturnCourseData(@PathVariable("id") int uid  ,@RequestBody CourseBasic newcourse) throws NumberFormatException, NoCourseException {
	...
	@ResponseStatus(HttpStatus.CREATED)
	public Iterable<Lectures> createLecture(@PathVariable("sectionID") int sectionID,@RequestBody Lectures lecture) throws NumberFormatException, NoSectionException {
...
//		return ResponseEntity.ok().body("ok");	
	...
	public ResponseEntity returnSectionList(@RequestBody Map<String,String> data) throws NumberFormatException, NoCourseException {
